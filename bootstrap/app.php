...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        // ⚠️ مسیرِ سلامت عمداً اینجا نیست.
        //
        // `health:` مسیرِ پیش‌فرضِ لاراول را می‌سازد که فقط می‌گوید «فریم‌ورک
        // بوت شد» — و اندازه‌گیری شد که با دیتابیسِ کاملاً از دسترس خارج هم
        // ۲۰۰ می‌دهد. چون همین مسیر در R42 دروازه‌ی بازگشتِ استقرار است،
        // جایش `HealthController` در routes/web.php نشسته (R43).
        then: function (): void {
            /*
            | نسخه‌بندیِ API (R10).
            |
