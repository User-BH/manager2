...
| جستجوهای اخیر | سایدبار | در `localStorage` می‌ماند، نه سرور: عبارت جستجو ممکن است نام و شماره‌ی افراد باشد. |
| ماشین حساب | `/calculator` | تاریخچه با تاریخ شمسی و ساعت در `localStorage`؛ حافظه‌ی MC/MR/M+/M−/MS. |
| اعلان‌ها | زنگوله + `/announcements` | شمارنده‌ی نخوانده، دراپ‌داون هاوری با ۳ اعلان، «نمایش همه اعلان‌ها». |
| پروفایل من | `/profile` | اطلاعات شخصی، واحدها، افراد مرتبط، مجتمع‌های وابسته، تغییر رمز. |
